...
In the future, an \acro{AI} agent might examine our changes and identify any regressions that we have introduced. For the moment, regression testing requires the manual creation of many on-disk files that describe the behavior of our code and how it should be validated.
