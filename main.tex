...
\begingroup
\centering
\input images/developer-focused-testing
\par
\endgroup
...
\begingroup
\centering
\input images/maintainer-focused-testing
\par
\endgroup
...
In the third ARQMath competition, the organizers used the same techniques to provide math formulae in the \acro{XML} format to participants.
