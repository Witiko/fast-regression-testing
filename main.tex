...
In order to decrease maintenance costs, tests should \emph{fail slow} to provide comprehensive feedback. Therefore, maintainers can configure our framework to always process all test files and produce a helpful summary of all errors.
